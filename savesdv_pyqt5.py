...
from PyQt5.QtWidgets import QApplication, QComboBox, QDialog, QFileDialog, QFormLayout, QHBoxLayout, QLabel, QLineEdit, QListWidget, QListWidgetItem, QMainWindow, QMessageBox, QPushButton, QSpinBox, QVBoxLayout, QWidget
...
class MainWindow(QMainWindow):
    ...
    def build(self):
        ...
        title = QLabel("SaveSDV"); title.setAlignment(Qt.AlignCenter); title.setStyleSheet("font-size: 34px; font-weight: 700;")
        outer.addStretch(); outer.addWidget(title, 0, Qt.AlignHCenter)
        ...
        outer.addStretch(); footer = QLabel(tr(self.lang, "footer")); footer.setWordWrap(True); footer.setAlignment(Qt.AlignRight | Qt.AlignBottom); outer.addWidget(footer)
